...
class PronterWindow(MainWindow, pronsole.pronsole):
    def __init__(self, filename = None, size = winsize):
        ...
        self.cpbuttons = [
            ...
            SpecialButton(_("Extrude 2"), ("extrude2"), (225, 200, 200), (6, 0), (1, 2), _("Advance extruder by set length")),
            SpecialButton(_("Reverse 2"), ("reverse2"), (225, 200, 200), (7, 0), (1, 2), _("Reverse extruder by set length")),
        ]
        self.custombuttons = []
        self.btndict = {}
    ...
    def update_tempdisplay(self):
        try:
            ...
            #t2_temp = parse_temperature_report(self.tempreport, "T2:")
            #t3_temp = parse_temperature_report(self.tempreport, "T3:")
            wx.CallAfter(self.status.SetStatusText, self.tempreport)
